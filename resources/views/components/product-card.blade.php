...
<head>
    <style>
        ...
        .ps-shoe__name {
            margin-bottom: 10px;
            /* تحديد المسافة بين اسم المنتج والسعر حسب الحاجة */
        }

        .ps-shoe__categories {
            margin-top: 10px;
            /* تحديد المسافة بين الصنف والسعر حسب الحاجة */
        }

        .ps-shoe__price {
            margin-top: 10px;
            
            /* تحديد المسافة بين السعر والعنصر التالي حسب الحاجة */
        }
    </style>
</head>
...
<div class="ps-shoe mb-30">
    <div class="ps-shoe__thumbnail">
        ...
        @if ($product->compare_price)
            <div class="ps-badge ps-badge--sale @if ($new) ps-badge--2nd @endif "><span>
                    {{ $product->discount_percent }}% </span></div>
        @endif
