     ...
     */
     ...
     public function store(Request $request)
     {
         ...
         if ($user && Hash::check($request->password, $user->password)) {
             /*
            name: The name of the token , It's also possible to include the device name so that 
            the user can download it to multiple devices. This is obtained from 
            the device name or from the name of the browser it uses through the request header.
            */
